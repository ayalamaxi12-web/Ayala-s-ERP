...
# ── Origen TACTICA (SQL Server) — ver TACTICA_SQL_RELEVAMIENTO.md ──
# Reemplaza la exportación manual de "Facturación → Análisis de productos".
TACTICA_SQL_SERVER = _env("RENT_TACTICA_SQL_SERVER")
TACTICA_SQL_DATABASE = _env("RENT_TACTICA_SQL_DATABASE")
TACTICA_SQL_USER = _env("RENT_TACTICA_SQL_USER")
TACTICA_SQL_PASSWORD = _env("RENT_TACTICA_SQL_PASSWORD")
