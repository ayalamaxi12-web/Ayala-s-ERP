...
| P · Precio de Venta | `precio_venta` | `facturasitems.ImportePrecioVenta1` (slot de pesos — `ImportePrecioVenta{N}` corresponde a `moneda.Numero=N`; slot 1 = Pesos) | Alta — magnitudes y relación con `ImportePrecioVenta2` (dólares) consistentes con el TC de la línea |
